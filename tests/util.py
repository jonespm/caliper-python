...
def rebuild_event(
    fixture, broken=False, thin_props=True, thin_context=True, described_objects=None
):
    f_dict = json.loads(get_fixture(fixture, broken))
    return _rebuild_caliper_serializable(
        f_dict, thin_props, thin_context, described_objects
    )
